...
func screenVIP(person: Clubgoer) {
    ...
    //if over 21 & on guest list admit(person: Clubgoer)
    // if not over 21 || not on guest list deny(person: Clubgoer)
    // UNLESS friend of owner . if know owner sendToOwner(person: Clubgoer)
